...
def main():
	datapath1='plothist_embryo/PT/'
	datapath2='plothist_postnatal/PT/'


	fig,ax=plt.subplots(2,2,figsize=(8,5))
	
	plot_everything(datapath1,ax,'r','E18.5 PT')
	plot_everything(datapath2,ax,'b','P40 PT')
	...
	fig.savefig('histogram_elevation_cluster_PT.png',bbox_inches='tight',dpi=300)
	fig.clf()
